  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[80%] md:max-w-[70%]">
        ...
        {/* Copy Button for Assistant Messages (Generic) */}
        {!isUser && !scheduleData.isValid && (
          <button
            onClick={handleCopyMessage}
            className="absolute -bottom-6 left-0 p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity"
            title={t("common.copy")}
          >
            <Copy size={14} />
          </button>
